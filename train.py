...
def train(content_img_path, style_img_path, n_epoch, lr, alpha, beta):
    ...
    with Progress(TextColumn("[bold blue] Transfering"), SpinnerColumn(spinner_name='growHorizontal'), BarColumn(), MofNCompleteColumn(), TextColumn('[ elapsed'), TimeElapsedColumn(), TextColumn('| eta'), TimeRemainingColumn(), TextColumn(f"] - Loss {total_loss}")) as progress:
        pbar = progress.add_task("Transfering", total=n_epoch)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", type=str, default="data/starry_night.jpeg")
    parser.add_argument("-c", type=str, default="data/ensae.jpeg")
    parser.add_argument("--alpha", type=int, default=8)
    parser.add_argument("--beta", type=int, default=70)
    parser.add_argument("--n_epoch", type=int, default=7000)
